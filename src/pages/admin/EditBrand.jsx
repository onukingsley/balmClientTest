...
export default function EditBrand() {
    ...
    const {brand} = productStore()


    const prod = brand.find((p) => p.id === parseInt(id));
    ...
    if (!prod) {
        return (
            <div className="text-center py-12">
                <p className="text-nude-600">Brand not found</p>
    ...
    const removeImage = (index) => {
        ...
        setFormData({ ...formData, brand_image: "" });
    ...
    const handleSubmit = (e) => {
        ...
        axiosClient.post("/updateBrand",payload,{
            headers: {
    ...
    return (
        <div>
            ...
            <div className="flex items-center gap-4 mb-8">
                ...
                <div>
                    <h1 className="text-3xl font-serif text-nude-900">Edit Brand</h1>
                    <p className="text-nude-600 mt-1">Update brand information</p>
                </div>
            </div>
            ...
            <form onSubmit={handleSubmit} className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div className="lg:col-span-2 space-y-6">
                    ...
                    <div className="bg-white rounded-2xl shadow-sm p-6">
                        ...
                        <div className="space-y-4">
                            <div>
                                <label className="text-sm text-nude-700 mb-2 block">Brand Name *</label>
                                <Input
                ...
                <div className="space-y-6">
                    {/* Images */}
                    <div className="bg-white rounded-2xl shadow-sm p-6">
                        <h2 className="text-lg font-serif text-nude-900 mb-6">Brand Image</h2>
                        <div className="space-y-4">
                            ...
                            <div className="grid grid-cols-3  gap-2">
                                ...
                                {prod.brand_image && (
                                    <div  className="relative aspect-square">
                                        <img
                                            src={`${import.meta.env.VITE_API_URL}/storage/${prod.brand_image}`}
                                            alt={prod.brand_image}
