...
export default function AddBrand() {
    ...
    const handleSubmit = (e) => {
        ...
        console.log(payload)
        axiosClient.post("/addBrand",payload,{
            headers: {
    ...
    return (
        <div>
            ...
            <div className="flex items-center gap-4 mb-8">
                ...
                <div>
                    <h1 className="text-3xl font-serif text-nude-900">Add Brand</h1>
                    <p className="text-nude-600 mt-1">Add a new brand to your catalog</p>
                </div>
            </div>
