...
export default function AddProduct() {
  ...
  const {category,brand} = productStore()
  ...
  return (
    <div>
      ...
      <div className="flex items-center gap-4 mb-8">
        ...
        <div>
          <h1 className="text-3xl font-serif text-nude-900">Add Product</h1>
      ...
      <form onSubmit={handleSubmit} className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="bg-white rounded-2xl shadow-sm p-6">
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  <label className="text-sm text-nude-700 mb-2 block">Brand *</label>
                  <select
        ...
        <div className="space-y-6">
          {/* Images */}
          <div className="bg-white rounded-2xl shadow-sm p-6">
            <h2 className="text-lg font-serif text-nude-900 mb-6">Product Images</h2>
            <div className="space-y-4">
